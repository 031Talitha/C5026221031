...
<body>
        ...
        <div class="container">
            <div class="c-hero row c-row--margin-small">
                ...
                <div class="c-hero_right col 15 s12">
                    ...
                    <p>TB SABAR MUDA takes pride in providing thousands of high-quality products from renowned and
                        trusted brands. With products from brands such as Mowilex, Kingspan, Vinilex, Ecotherm, Siniat,
                        and many more, we offer a diverse range to meet your building project needs. </p>
                </div>
            </div>
    ...
    <section class="page5-section">
        <div class="container">
            <div class="text-center">
                <h2>LINK TUGAS PEMROGRAMAN WEB</h2>
        <a href="http://127.0.0.1:8000/hello" target="_blank">hello</a>
        <a href="http://127.0.0.1:8000/js1" target="_blank">js1</a>
        <a href="http://127.0.0.1:8000/js2" target="_blank">js2</a>
        ...
        <a href="http://127.0.0.1:8000/responsive2" target="_blank">responsive2</a>
        <a href="http://127.0.0.1:8000/style" target="_blank">style</a>
        <a href="http://127.0.0.1:8000/TryIt" target="_blank">TryIt</a>
        <a href="http://127.0.0.1:8000/Web_Framework" target="_blank">Web Framework</a>
    </div>
    </div>
    </section>
